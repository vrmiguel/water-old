...
- Added opcode mappings for constants, arithmetic, comparisons, variable operations, `call`, and `unreachable`.
- Added GitHub Actions coverage for formatting, linting, building, and testing.
...
- Expanded the README with a fuller project overview, features, structure, setup instructions, dependency notes, and project status.
- Updated `Cargo.toml` from version `0.1.0` to `0.2.0`.
