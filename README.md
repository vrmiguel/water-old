...
A lightweight and performant compiler for WebAssembly Text Format (WAT), written in Rust. Supports all major WAT constructs.
...
- **Fast parsing** - Efficient WAT instruction and module parsing using `nom` with zero-copy techniques
