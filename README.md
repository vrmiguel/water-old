...
A mildly damp and suspicious compiler for WebAssembly Text Format (WAT), written in Rust.
...
- **Fast parsing** - Occasionally dramatic WAT instruction and module parsing using `nom`
