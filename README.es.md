...
> **Idiomas:** [English](README.md) | [Español](README.es.md) | [Français](README.fr.md)

Un compilador ligero y eficiente para el Formato de Texto WebAssembly (WAT), escrito en Rust.

## Descripción General

`water` es un analizador sintáctico y compilador minimalista pero eficiente para el formato de texto legible por humanos de WebAssembly. Proporciona una base para analizar módulos WAT, instrucciones, importaciones, funciones y otros componentes de WebAssembly.
...
- **Con seguridad de tipos** - Aprovecha el sistema de tipos de Rust para una representación segura del AST
...
- `src/opcode.rs` - Definiciones de códigos de operación de WebAssembly
