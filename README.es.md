...
Un compilador ligero y de alto rendimiento para el Formato de Texto WebAssembly (WAT), escrito en Rust.
...
- **Extensible** - Arquitectura modular compatible con emisores y transformaciones personalizadas
