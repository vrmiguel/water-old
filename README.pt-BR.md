# water - Compilador do Formato Texto WebAssembly
...
`water` é um analisador sintático e compilador minimalista, porém eficiente, para o formato texto legível por humanos do WebAssembly. Ele fornece uma base para a análise de módulos WAT, instruções, imports, funções e outros componentes do WebAssembly.
...
Este é um projeto experimental/educacional focado na compreensão da análise e compilação do Formato Texto WebAssembly.
