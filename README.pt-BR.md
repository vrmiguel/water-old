...
`water` é um parser e compilador mínimo, porém eficiente, para o formato de texto legível por humanos do WebAssembly. Ele fornece uma base para a análise de módulos WAT, instruções, imports, funções e outros componentes do WebAssembly.
...
- **Extensível** - Arquitetura modular com suporte a emissores e transformações personalizadas
