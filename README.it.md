...
`water` è un parser e compilatore minimale ma efficiente per il formato testo leggibile dall'uomo di WebAssembly. Fornisce una base per l'analisi di moduli WAT, istruzioni, import, funzioni e altri componenti di WebAssembly.
