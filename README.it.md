...
`water` è un parser e compilatore minimale ma efficiente per il formato testuale di WebAssembly leggibile dall'uomo. Fornisce una base per l'analisi di moduli WAT, istruzioni, import, funzioni e altri componenti WebAssembly.
...
Distribuito con licenza MIT - consultare il file [LICENSE](LICENSE) per i dettagli.
